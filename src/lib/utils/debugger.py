...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    if dataset == 'coco_hp':
      ...
      self.W = 1242
      self.H = 375
    elif num_classes == 4 or dataset == 'pictor':
      self.names = pictor_class_name
      self. focal_length = 935
      self.W = 1221
      self.H = 912
  ...
  def show_img(self, pause = False, imgId = 'default'):
    ...
    # self.save_img(self.imgs[imgId], 'test_result.jpg')
